...
ggsave("Power_analysis.jpeg", plot = power_plots, path = "C:/Users/yongwal/Desktop/Methods 3 Justina")
...
real_data <- ggplot(data_clean, aes(Visit, CHI_MLU, color = Diagnosis, group = ID)) + 
  ...
  geom_line(alpha = 0.3) + 
  ggtitle("Real data")
sim_vs_emp <- grid.arrange(simulated_data, real_data)

ggsave("sim_emp.jpeg", plot = sim_vs_emp, path = "C:/Users/yongwal/Desktop/Methods 3 Justina")
sim_vs_emp
```
